...
#define __PYX_HAVE__meu_codigo
#define __PYX_HAVE_API__meu_codigo
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "meu_codigo" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "meu_codigo"
extern int __pyx_module_is_main_meu_codigo;
int __pyx_module_is_main_meu_codigo = 0;

/* Implementation of "meu_codigo" */
...
static int __pyx_pymod_exec_meu_codigo(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_meu_codigo},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_meu_codigo(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_meu_codigo(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_meu_codigo(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'meu_codigo' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "meu_codigo" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_meu_codigo", 0);
  ...
  if (__pyx_module_is_main_meu_codigo) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "meu_codigo")) {
      if (unlikely((PyDict_SetItemString(modules, "meu_codigo", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init meu_codigo", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init meu_codigo");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
#endif
{
...
#endif
    if (PyImport_AppendInittab("meu_codigo", PyInit_meu_codigo) < 0) return 1;
#if PY_VERSION_HEX < 0x03080000
    Py_Initialize();
    if (argc && argv)
    ...
    {
      PyObject* m = NULL;
      __pyx_module_is_main_meu_codigo = 1;
      m = PyImport_ImportModule("meu_codigo");
      if (!m && PyErr_Occurred()) {
          PyErr_Print();
          return 1;
      }
